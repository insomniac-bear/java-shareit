...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingResponseDto createBooking(Long userId, NewBookingRequestDto newBooking) {
        ...
        Booking booking = bookingRepository.save(mapper.newBookingToBooking(newBooking, bookingItem, booker));
        BookingResponseDto bookingResponse = mapper.bookingToBookingResponseDto(booking);
    ...
    public BookingResponseDto changeAvailableBooking(Long bookingId, boolean isBooking, Long userId) {
        ...
        BookingResponseDto updatedBooking = mapper.bookingToBookingResponseDto(booking);
    ...
    public BookingResponseDto getBooking(Long bookingId, Long userId) {
        ...
        BookingResponseDto res = mapper.bookingToBookingResponseDto(booking);
    ...
    public List<BookingResponseDto> getBookings(Long userId, BookingState state, RequestRole role) {
        ...
        List<BookingResponseDto> resBookings = mapper.mapToBookingResponseDto(bookings);
